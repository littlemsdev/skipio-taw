module Skipio
  ...
  class Contact < Base
    ...
    attr_accessor :id, :first_name, :last_name, :phone_mobile, :avatar_url
    ...
    def self.random(clear_cache)
      ...
      response = Request.where("contacts?token=d3ef07cd3fb17859a874b7854c84f0ec", cache)
    ...
    def self.find(id)
      response = Request.get("contacts/#{id}?token='d3ef07cd3fb17859a874b7854c84f0ec'", CACHE_DEFAULTS)
